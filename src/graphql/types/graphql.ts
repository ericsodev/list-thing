...
export type ListBySlugQuery = { __typename?: 'Query', listSlug?: { __typename?: 'List', id: string, name: string, memberCount: number, itemCount: number, slug: string, items: Array<{ __typename?: 'Item', id: string, name: string }> } | null };
