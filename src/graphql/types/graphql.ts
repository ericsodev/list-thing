...
export type ListBySlugQuery = { __typename?: 'Query', list?: { __typename?: 'List', id: number, name: string, memberCount: number, itemCount: number, slug: string, items: Array<{ __typename?: 'Item', id: number, name: string, tags: Array<{ __typename?: 'Tag', id: number, name: string }> }> } | null };
