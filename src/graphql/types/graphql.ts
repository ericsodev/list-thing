...
export type GetListQueryQuery = {
    __typename?: "Query";
    list?: { __typename?: "List"; name: string } | null;
};
...
export const GetListQueryDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetListQuery" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
                        ...
                        arguments: [
                            {
                                ...
                                value: { kind: "StringValue", value: "sdfsdf", block: false },
                            },
                        ],
                        selectionSet: {
                            kind: "SelectionSet",
...
} as unknown as DocumentNode<GetListQueryQuery, GetListQueryQueryVariables>;
